...
class HomeDriversDetailScreen: UIView {
    ...
    lazy var infoDriversTableView: UITableView = {
        ...
        tableView.register(HomeInfoDriversCustomTableViewCellScreen.self, forCellReuseIdentifier: HomeInfoDriversCustomTableViewCellScreen.identifier)
        return tableView
    }()
