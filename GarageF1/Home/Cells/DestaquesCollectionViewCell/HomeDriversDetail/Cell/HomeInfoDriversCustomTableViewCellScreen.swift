//
//  HomeInfoDriversCustomTableViewCellScreen.swift
//  GarageF1
//
...
class HomeInfoDriversCustomTableViewCellScreen: UITableViewCell {
    
    static let identifier = String(describing: HomeInfoDriversCustomTableViewCellScreen.self)
