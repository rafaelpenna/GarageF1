//
//  HomeDriversDetailViewModel.swift
//  GarageF1
//
...
enum HomeDriversTypeFetch {
    case mock
    case request
}

protocol HomeDriversDetailViewModelProtocol: AnyObject {
    func reloadTableView()
}

protocol HomeDriversDetailViewModelDelegate: AnyObject {
    func success()
...
class HomeDriversDetailViewModel {
    ...
    public func fetch(_ typeFetch: HomeDriversTypeFetch){
        switch typeFetch {
        case .mock:
