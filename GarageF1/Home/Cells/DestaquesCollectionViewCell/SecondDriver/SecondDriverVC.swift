...
class SecondDriverVC: UIViewController {
    ...
    var secondDriverViewModel: SecondDriverViewModel = SecondDriverViewModel()
...
extension SecondDriverVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            cell?.birthDateAnswer.text = secondDriverViewModel.getBirthDate()
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.birbirthLocationAnswer.text = secondDriverViewModel.getBirthLocation()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.championshipsWinAnswer.text = secondDriverViewModel.getChampionshipsWon()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.racesAnswer.text = secondDriverViewModel.getRacesParticipated()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.podiumsAnswer.text = secondDriverViewModel.getPodiumsEarned()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.pointsAnswer.text = secondDriverViewModel.getPointsEarned()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.bestRacePositionAnswer.text = secondDriverViewModel.getBestPositionRaces()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
        } else {
            ...
            cell?.configure()
            let backgroundView = UIView()
            cell?.bestGridPositionAnswer.text = secondDriverViewModel.getBestGridPosition()
            backgroundView.backgroundColor = .none
            cell?.selectedBackgroundView = backgroundView
            return cell ?? UITableViewCell()
        }
