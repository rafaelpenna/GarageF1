...
protocol firstDriverScreenProtocol: AnyObject {
    func tappedBackButton()
}

class FirstDriverScreen: UIView {
    
    private weak var delegate: firstDriverScreenProtocol?
    func delegate(delegate: firstDriverScreenProtocol?) {
