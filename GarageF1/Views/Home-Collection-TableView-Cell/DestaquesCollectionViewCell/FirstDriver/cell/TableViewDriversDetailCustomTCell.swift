//
//  TableViewDriversDetailCustomTCell.swift
//  GarageF1
//
...
class TableViewDriversDetailCustomTCell: UITableViewCell {
    ...
    private func configScreenConstraints(){
        NSLayoutConstraint.activate([
            tableViewBirthDateCellScreen.leadingAnchor.constraint(equalTo: leadingAnchor),
            tableViewBirthDateCellScreen.trailingAnchor.constraint(equalTo: trailingAnchor),
            tableViewBirthDateCellScreen.topAnchor.constraint(equalTo: topAnchor),
            tableViewBirthDateCellScreen.bottomAnchor.constraint(equalTo: bottomAnchor),
