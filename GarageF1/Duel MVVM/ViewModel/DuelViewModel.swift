...
class DuelViewModel {
    ...
    var dataDriversLeft: [DuelModel] = [DuelModel(driversName: "Michael", driversLastName: "Schumacher", driversBirthDate: "03/01/1969", driversAge: "(53 anos)", driversBirthPlace: "Hurth-Hermullheim", driversCountry: "Alemanha", championshipsWon: "7 (1994, 1995, 2000, 2002, 2003 e 2004)", racesParticipated: "308", podiumsWon: "155", pointsEarned: "1566", wins: "91")]
...
//    private var data: DuelModel
//    
//    init(data:DuelModel){
//        self.data = data
//    }
//    
//    public var getDriversNameLeft: String {
